...
public class AnnotationServletV2 implements HttpServlet {
    ...
    private void invoke(Object controller, Method method, HttpRequest request, HttpResponse response) {
        Object[] args = bindParameter(controller, method, request, response);
    ...
    private Object[] bindParameter(Object controller, Method method, HttpRequest request, HttpResponse response) {
